...
2. Open the plugins/pico_edit/config.php file and insert your sha1 hashed password
3. Visit https://www.yoursite.com/pico_edit and login
...
Options ("plugins/pico_edit/config.php"):
